...
<div style="margin-left:10px;margin-bottom:10px;">
	<input type="text" name="{$namePrefix}[name]" value="{$params.name}" class="placeholders" spellcheck="false" size="45" style="width:100%;" placeholder="e.g. Apple 27-inch iMac 3.2GHz Quad-Core Intel i5 32GB RAM">
</div>
...
{include file="devblocks:cerberusweb.core::internal/decisions/actions/_shared_add_custom_fieldsets.tpl" context=CerberusContexts::CONTEXT_ASSET field_wrapper="{$namePrefix}"}
...
{if $var.type == "ctx_{CerberusContexts::CONTEXT_ASSET}"}
